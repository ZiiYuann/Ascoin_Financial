...
UPDATE financial_record a, (SELECT id, hold_amount FROM financial_record)
    b
set a.income_amount = b.hold_amount
WHERE a.id = b.id;

UPDATE financial_product a ,
    (SELECT product_id, sum(hold_amount) as amount
     FROM financial_record
     WHERE `status` = 'PROCESS'
     GROUP BY product_id) b
SET a.use_quota = b.amount
...
(
  ...
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='产品阶梯配置表';
...
(
    ...
    `finish`       tinyint(1)                                                   NULL COMMENT '是否完成',
    `try_times`    tinyint(1)                                                   NULL COMMENT '尝试次数',
    PRIMARY KEY (`id`)
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='预订单表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='异常信息表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='云钱包代理人';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='云钱包代理人和产品关联';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='基金交易记录';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='基金审核记录';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='基金持有记录';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='基金收益记录';
...
ALTER TABLE `financial_income_daily`
    ADD COLUMN `order_no` varchar(30)    NULL COMMENT '订单号' AFTER `finish_time`,
    ADD COLUMN `rate`     decimal(10, 4) NULL COMMENT '汇率' AFTER `order_no`,
