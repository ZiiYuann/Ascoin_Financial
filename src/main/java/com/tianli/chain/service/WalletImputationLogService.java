...
public class WalletImputationLogService extends ServiceImpl<WalletImputationLogMapper, WalletImputationLog> {
    ...
    public WalletImputationLog getOneByTxid(String txid, ImputationStatus imputationStatus) {
        return walletImputationLogMapper.selectOne(new LambdaQueryWrapper<WalletImputationLog>()
                .eq(WalletImputationLog::getTxid, txid)
                .eq(WalletImputationLog::getStatus, imputationStatus));
    }
}
