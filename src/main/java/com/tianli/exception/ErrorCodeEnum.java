...
public enum ErrorCodeEnum {
    ...
    /*** －－－－－－业务错误码-借币相关－－－－－－*/
    BORROW_CONFIG_NO_EXIST(3500,"币种配置为空"),
    BORROW_CONFIG_EXIST(3501,"币种配置已存在"),
    BORROW_CONFIG_USED(3502,"币种配置已被使用"),
    BORROW_GT_AVAILABLE_ERROR(3503,"借币数量大于可用数量"),
    BORROW_RANGE_ERROR(3504,"借币数量小于最小数量或大于最大数量"),
    BORROW_ORDER_NO_EXIST(3505,"借币订单不存在"),
    REPAY_GT_CAPITAL(3506,"还款金额大于需要还款金额"),
    ADJUST_GT_AVAILABLE(3507,"调整金额大于可用金额"),
    PLEDGE_RATE_RANGE_ERROR(3508,"质押率范围错误"),
    CURRENCY_COIN_ERROR(3509,"币别错误"),
    PLEDGE_LT_LIQUIDATION(3510,"质押率小于平仓率"),
    ;
    private int errorNo;
