...
public class FundController {
    ...
    public Result incomeRecord(PageQuery<FundIncomeRecord> page , Long fundId){
        IPage<FundIncomeRecordVO> fundIncomeRecordPage = fundRecordService.incomeRecord(page, fundId);
