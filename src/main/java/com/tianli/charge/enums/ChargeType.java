...
public enum ChargeType {
    ...
    income("Earnings", "收益", AccountChangeType.income,ChargeTypeGroupEnum.IN),
    purchase("Subscription", "申购", AccountChangeType.purchase,ChargeTypeGroupEnum.OUT),
    ...
    settle("Settlement", "结算", AccountChangeType.settle,ChargeTypeGroupEnum.IN),
    ...
    transfer_increase("Transfer Increase", "划转增加", AccountChangeType.transfer_increase,ChargeTypeGroupEnum.IN),
    transfer_reduce("Transfer Reduce", "划转减少", AccountChangeType.transfer_reduce,ChargeTypeGroupEnum.OUT),
