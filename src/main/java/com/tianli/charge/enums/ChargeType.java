...
public enum ChargeType {
    ...
    agent_fund_sale("Sales Revenue", "用户申购", AccountChangeType.agent_fund_sale,ChargeTypeGroupEnum.IN),
    ...
    transfer_increase("Transfer Increase", "划转", AccountChangeType.transfer_increase,ChargeTypeGroupEnum.IN),
    transfer_reduce("Transfer Reduce", "划转", AccountChangeType.transfer_reduce,ChargeTypeGroupEnum.OUT),
