...
public enum ChargeType {
    ...
    withdraw_success("Successful Withdrawal", "提币成功",AccountChangeType.withdraw,ChargeTypeGroupEnum.WITHDRAW),
    withdraw_failed("Failed Withdrawal", "提币失败",AccountChangeType.withdraw,ChargeTypeGroupEnum.WITHDRAW),
    withdraw_freeze("Freeze Withdrawal", "提币冻结",AccountChangeType.withdraw,ChargeTypeGroupEnum.WITHDRAW),
    ;
