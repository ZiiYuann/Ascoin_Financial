...
//    tr_success("已发放{1}笔", "{1} Receiving Record", ChargeType.transaction_reward, ChargeStatus.chain_success),
    ...
    transfer_fail("转存失败", "Failed Transfer ", ChargeType.transfer, ChargeStatus.review_fail),
    ...
    red_give_fail("发送失败", "Failed Send ", ChargeType.red_give, ChargeStatus.review_fail),
    agent_fund_redeem_success("支付成功", "Successful Payment", ChargeType.agent_fund_redeem, ChargeStatus.chain_success),
    agent_fund_redeem_fail("支付失败", "Failed Payment ", ChargeType.agent_fund_redeem, ChargeStatus.review_fail),
    agent_fund_interest_success("支付成功", "Successful Payment", ChargeType.agent_fund_interest, ChargeStatus.chain_success),
    agent_fund_interest_fail("支付失败", "Failed Payment ", ChargeType.agent_fund_interest, ChargeStatus.review_fail),
