 ...
 * @date 2022/5/6 16:37
 */
@Service("emailWithdrawalSuccessService")
public class EmailWithdrawalSuccessService implements EmailSendStrategy {
    ...
    public void send(String emailAddress, EmailSendEnum emailSendEnum, Long id, Object data) {
        ...
        String context = StrUtil.format(emailSendEnum.getMsgContext(),
                sgCharge.getReal_amount().toString(),
                sgCharge.getTo_address(),
                sgCharge.getTxid());
