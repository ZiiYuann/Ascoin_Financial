...
import org.tron.tronj.abi.datatypes.generated.Uint160;
import org.tron.tronj.abi.datatypes.primitive.Double;
import org.tron.tronj.abi.datatypes.primitive.Float;
...
public class TypeDecoder {
    ...
    static Type instantiateArrayType(TypeReference ref, Object value)
        ...
        if (arraySize <= 0) {
            ...
            Class<?> arrayClass =
                    Class.forName("org.tron.tronj.abi.datatypes.generated.StaticArray" + arraySize);
        ...
        try {
            Class<? extends StaticArray> arrayClass =
                    (Class<? extends StaticArray>)
                            Class.forName("org.tron.tronj.abi.datatypes.generated.StaticArray" + length);
